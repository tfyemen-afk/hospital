<h2><?=$this->lang->line('page_attachment_details')?></h2>
<div class="attached-info">
    ...
    <div class="attached-thumb-details">                               
        ...
        <button type="button" class="delete-attachment" id="<?=$image_info->media_galleryID?>" onclick="deleteFileInfo(this)"><?=$this->lang->line('page_delete_permanently')?></button>
    </div>
</div>
...
<div class="attached-form">
    <form>
        ...
        <div class="form-group">
            <label for="file_artist"><?=$this->lang->line('page_artist')?></label>
        ...
        <div class="form-group">
            <label for="file_album"><?=$this->lang->line('page_album')?></label>
        ...
        <div class="form-group">
            <label for="file_caption"><?=$this->lang->line('page_caption')?></label>
        ...
        <div class="form-group hide">
            <label for="file_alt_text"><?=$this->lang->line('page_alt_text')?></label>
        ...
        <div class="form-group">
            <label for="file_description"><?=$this->lang->line('page_description')?></label>
