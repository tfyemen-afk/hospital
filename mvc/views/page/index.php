        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> <?=$this->lang->line('menu_page')?></a></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <ul class="nav nav-tabs" id="custom_tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link <?=$activetab ? 'active' : ''?>" id="list_tab" data-toggle="tab" href="#list" role="tab" aria-controls="list" aria-selected="true"><i class="fa fa-table"></i> <?=$this->lang->line('page_list')?></a>
                    </li>
                    <?php if(permissionChecker('page_add')) { ?>
                        <li class="nav-item">
                            <a class="nav-link <?=$activetab ? '' : 'active'?>" id="add_tab" data-toggle="tab" href="#add" role="tab" aria-controls="add" aria-selected="false"><i class="fa fa-plus-square-o"></i> <?=$this->lang->line('page_add')?></a>
                        </li>
                    <?php } ?>
                </ul>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="add--page--wrap">
                                            <h3><?=$this->lang->line('page_add_new_page')?></h3>

                                            <div class="form-group <?=form_error('title') ? 'has-error' : '' ?>">
                                                <input type="text" id="title" value="<?=set_value('title')?>" name="title" class="form-control" placeholder="<?=$this->lang->line('page_enter_title_here')?>">
                                            ...
                                            <div class="bg-white mb-15">
                                                ...
                                                <div class="sidebar-body" id="publish-box">
                                                    <div class="save-preview-btn clearfix">
                                                        <!-- <a href="#" class="btn-preview pull-right"><?=$this->lang->line('page_preview')?></a> -->

                                                        <button type="submit" id="preview" class="save-preview-btn pull-right clearfix" value="preview" name="submit"><?=$this->lang->line('page_preview')?></button>

                                                        <?php
                                                        if($send_status == 'draft')
                                                            echo '<button type="submit" class="btn-save-status pull-left" value="draft" name="submit">'.$this->lang->line('page_save_draft').'</button>';
                                                        elseif($send_status == 'review')
                                                            echo '<button type="submit" class="btn-save-status pull-left" value="review" name="submit">'.$this->lang->line('page_save_as_pending').'</button>';
                                                        ?>
                                                    ...
                                                    <div class="post-status">
                                                        ...
                                                        if($send_visibility == 1)
                                                            echo $this->lang->line('page_public');
                                                        elseif($send_visibility == 2)
                                                            echo $this->lang->line('page_password_protected');
                                                        elseif($send_visibility == 3)
                                                            echo $this->lang->line('page_private');
                                                        ?>
                                                ...
                                                <div id="publish-box-footer" class="publish-btn text-right">
                                                    <input type="submit" name="submit" value="<?=$this->lang->line('page_publish')?>">
                                                </div>
                                            </div>
