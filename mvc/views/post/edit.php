        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?=site_url('post/index')?>"><?=$this->lang->line('menu_post')?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('post_edit')?></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <ul class="nav nav-tabs" id="custom_tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" id="list_tab" data-toggle="tab" href="#list" role="tab" aria-controls="list" aria-selected="true"><i class="fa fa-table"></i> <?=$this->lang->line('post_list')?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" id="add_tab" data-toggle="tab" href="#edit" role="tab" aria-controls="edit" aria-selected="false"><i class="fa fa-edit"></i> <?=$this->lang->line('post_edit')?></a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane bg-color fade" id="list" role="tabpanel" aria-labelledby="list_tab">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="add--page--wrap">
                                        <h4><?=$this->lang->line('post_edit_page')?></h4>
                                        <div class="form-group <?=form_error('title') ? 'has-error' : '' ?>">
                                            <input type="text" id="title" value="<?=set_value('title', $post->title)?>" name="title" class="form-control" placeholder="<?=$this->lang->line('post_enter_title_here')?>">
                                        ...
                                        <div class="bg-white mb-15">
                                            ...
                                            <div class="sidebar-body" id="publish-box">
                                                <div class="save-preview-btn clearfix">
                                                    <button type="submit" id="preview" class="save-preview-btn pull-right clearfix" value="preview" name="submit"><?=$this->lang->line('post_preview_changes')?></button>
                                                ...
                                                <div class="post-status">
                                                    ...
                                                    <span id="status-message" class="bold">
                                                        <?php
                                                            ...
                                                            elseif($send_status == 'published')
                                                                echo $this->lang->line('post_published');
                                                        ?>
                                                    </span>
                                                    ...
                                                    <div class="post-status-select" id="draft-edit-show">
                                                        <?php 
                                                            $statusArray = array(
                                                                'published' => $this->lang->line('post_published'),
                                                ...
                                                <div class="post-status">
                                                    ...
                                                    <div class="post-status-select" id="publish-edit-show">
                                                        <?php
                                                            ...
                                                            echo form_dropdown("publish_month", $monthArray, set_value("publish_month", date("m", strtotime($post->publish_date))), "id='publish_month' class='".$addClass."'"); 
                                                        ?>
                                                        <label class="sr-only">Day</label>
                                                        <input id="publish_day" name="publish_day" type="text" value="<?=set_value('publish_day', date("d", strtotime($post->publish_date)))?>" size="2" class="<?=$addClass?>" maxlength="2">
                                                        <label class="sr-only">year</label>
                                                        <input id="publish_year" name="publish_year" type="text" value="<?=set_value('publish_year', date("Y", strtotime($post->publish_date)))?>" size="4" class="<?=$addClass?>" maxlength="4">
                                                        <span>@</span>
                                                        <input id="publish_hour" name="publish_hour" type="text" value="<?=set_value('publish_hour', date("H", strtotime($post->publish_date)))?>" size="2" class="<?=$addClass?>" maxlength="2">
                                                        <span>:</span>
                                                        <input id="publish_minute" name="publish_minute" type="text" value="<?=set_value('publish_minute', date("i", strtotime($post->publish_date)))?>" size="2" class="<?=$addClass?>" maxlength="2">
                                            ...
                                            <div id="publish-box-footer" class="publish-btn text-right">
                                                <input type="submit" name="submit" value="<?=$this->lang->line('post_update')?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="bg-white mb-15">
                                            ...
                                            <div class="sidebar-body" id="category-box">
                                                <div class="">
                                                    ...
                                                    ?>
                                                            <div class="form-group ini-dis-flex">
                                                                <input id="<?=$postcategorie->postcategoriesID?>" class="categories" name="categories[]" value="<?=$postcategorie->postcategoriesID?>" type="checkbox"  <?php if(inicompute($send_category)) { if(in_array($postcategorie->postcategoriesID, $send_category)) { echo 'checked'; } } ?> >
                                                                <label for="<?=$postcategorie->postcategoriesID?>"><?=$postcategorie->postcategories?></label>
                                                            </div>
                                                    <?php
                                                            }
                                                        }
