<h2><?=$this->lang->line('post_slider_images')?></h2>
<div class="nav_custom_tabs">
    <ul class="nav nav-tabs" id="custom_tab" role="tablist">
        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#setSliderImagesMediaUpload"><?=$this->lang->line('post_upload_files')?></a></li>
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#setSliderImagesMediaUploadLibrary"><?=$this->lang->line('post_media_library')?></a></li>
    </ul>
    ...
    <div class="tab-content no-padd">
        ...
        <div class="footer--upload">
            <a id="set_slider_images" data-dismiss="modal" onclick="setFileToEditor(this, 'set_slider_images_hidden_field', 'set_slider_images_type');" href="#"><?=$this->lang->line('post_set_slider_image')?></a>
        </div>
    </div>
</div>