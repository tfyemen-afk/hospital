<article class="content">
        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_medicinemanufacturer')?></li>
                </ol>
            </nav>
        </div>
    </div>
    <section class="section">
        <div class="row">
            <?php if(permissionChecker('medicinemanufacturer_add')) { ?>
                <div class="col-sm-4">
                        ...
                        <form role="form" method="POST">
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group <?=form_error('supplier_name') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('supplier_name') ? 'is-invalid' : '' ?>" id="supplier_name" name="supplier_name" value="<?=set_value('supplier_name')?>">
                                ...
                                <div class="form-group <?=form_error('details') ? 'text-danger' : '' ?>">
                                    ...
                                    <textarea type="text" class="form-control <?=form_error('details') ? 'is-invalid' : '' ?>" id="details" name="details"><?=set_value('details')?></textarea>
                                    <span class="text-danger"><?=form_error('details')?></span>
                                </div>
                            </div>
                            <div class="card-footer"> 
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('medicinemanufacturer_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php } ?>
            <div class="<?=(permissionChecker('medicinemanufacturer_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
