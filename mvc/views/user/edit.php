        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('user_edit')?></li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <form role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-block">
                            <div class="form-group <?=form_error('name') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('name') ? 'is-invalid' : '' ?>" id="name" name="name"  value="<?=set_value('name', $user->name)?>">
                            ...
                            <div class="form-group <?=form_error('designationID') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="designationID"><?=$this->lang->line('user_designation')?><span class="text-danger"> *</span></label>
                                    ...
                                    echo form_dropdown('designationID', $designationArray,  set_value('designationID', $user->designationID), ' id="designationID" class="form-control select2 '.$errorClass.'"')?>
                             ...
                             <div class="form-group doctorExtra <?=form_error('departmentID') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="departmentID"><?=$this->lang->line('user_department')?><span class="text-danger"> *</span></label>
                                    ...
                                    echo form_dropdown('departmentID', $departmentArray,  set_value('departmentID', $doctorinfo->departmentID), ' id="departmentID" class="form-control select2 '.$errorClass.'"')?>
                            ...
                            <div class="form-group <?=form_error('description') ? 'text-danger' : '' ?>">
                                ...
                                <textarea type="text" class="form-control <?=form_error('description') ? 'is-invalid' : '' ?>" id="description" name="description" ><?=set_value('description', $user->description)?></textarea>
                            ...
                            <div class="form-group <?=form_error('gender') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="gender"><?=$this->lang->line('user_gender')?><span class="text-danger"> *</span></label>
                                    ...
                                    echo form_dropdown('gender', $genderArray,  set_value('gender', $user->gender), ' class="form-control select2 '.$errorClass.'" ')?>
                            ...
                            <div class="form-group <?=form_error('dob') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('dob') ? 'is-invalid' : '' ?>" id="dob" name="dob"  value="<?=set_value('dob', date('d-m-Y', strtotime($user->dob)))?>">
                            ...
                            <div class="form-group <?=form_error('religion') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('religion') ? 'is-invalid' : '' ?>" id="religion" name="religion"  value="<?=set_value('religion', $user->religion)?>">
                            ...
                            <div class="form-group <?=form_error('address') ? 'text-danger' : '' ?>">
                                ...
                                <textarea type="text" class="form-control <?=form_error('address') ? 'is-invalid' : '' ?>" id="address" name="address"  ><?=set_value('address', $user->address)?></textarea>
                            ...
                            <div class="form-group <?=form_error('jod') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('jod') ? 'is-invalid' : '' ?>" id="jod" name="jod"  value="<?=set_value('jod', date('d-m-Y', strtotime($user->jod)))?>">
                            ...
                            <div class="doctorExtra">
                                <div class="form-group <?=form_error('visit_fee') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('visit_fee') ? 'is-invalid' : '' ?>" id="visit_fee" name="visit_fee"  value="<?=set_value('visit_fee', $doctorinfo->visit_fee)?>">
                                ...
                                <div class="form-group <?=form_error('online_consultation') ? 'text-danger' : '' ?>">
                                    <label class="control-label" for="online_consultation"><?=$this->lang->line('user_online_consultation')?><span class="text-danger"> *</span></label>
                                        ...
                                        echo form_dropdown('online_consultation', $onlineConsultationArray,  set_value('online_consultation', $doctorinfo->online_consultation), ' class="form-control select2 '.$errorClass.'" ')?>
                                ...
                                <div class="form-group <?=form_error('consultation_fee') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('consultation_fee') ? 'is-invalid' : '' ?>" id="consultation_fee" name="consultation_fee"  value="<?=set_value('consultation_fee', $doctorinfo->consultation_fee)?>">
                            ...
                            <div class="form-group <?=form_error('roleID') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="role"><?=$this->lang->line('user_role')?><span class="text-danger"> *</span></label>
                                    ...
                                    $errorClass = form_error('gender') ? 'is-invalid' : '';
                                    echo form_dropdown('roleID', $roleArray, set_value('roleID', $user->roleID), ' class="form-control select2 '.$errorClass.'" ')?>
                            ...
                            <div class="form-group <?=form_error('status') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="status"><?=$this->lang->line('user_status')?><span class="text-danger"> *</span></label>
                                    ...
                                    echo form_dropdown('status', $statusArray,  set_value('status', $user->status), ' class="form-control select2 '.$errorClass.'" ')?>
                        ...
                        <div class="card-footer"> 
                            <button type="submit" class="btn btn-primary"><?=$this->lang->line('user_update')?></button>
                        </div>
                    </form>
                </div>
            </div>
