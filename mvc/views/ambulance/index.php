<article class="content">
        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_ambulance')?></li>
                </ol>
            </nav>
        </div>
    </div>
    <section class="section">
        <div class="row">
            <?php if(permissionChecker('ambulance_add')) { ?>
                <div class="col-sm-4">
                        ...
                        <form role="form" method="POST">
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group <?=form_error('number') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('number') ? 'is-invalid' : '' ?>" id="number" name="number"  value="<?=set_value('number')?>">
                                ...
                                <div class="form-group <?=form_error('model') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('model') ? 'is-invalid' : '' ?>" id="model" name="model"  value="<?=set_value('model')?>">
                                ...
                                <div class="form-group <?=form_error('color') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('color') ? 'is-invalid' : '' ?>" id="color" name="color"  value="<?=set_value('color')?>">
                                ...
                                <div class="form-group <?=form_error('cc') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('cc') ? 'is-invalid' : '' ?>" id="cc" name="cc"  value="<?=set_value('cc')?>">
                                ...
                                <div class="form-group <?=form_error('weight') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('weight') ? 'is-invalid' : '' ?>" id="weight" name="weight"  value="<?=set_value('weight')?>">
                                ...
                                <div class="form-group <?=form_error('fueltype') ? 'text-danger' : '' ?>">
                                    <label class="control-label" for="fueltype"><?=$this->lang->line('ambulance_fuel_type')?> <span class="text-danger">*</span></label>
                                        ...
                                        echo form_dropdown('fueltype', $fueltypeArray,  set_value('fueltype'), ' class="form-control select2 '.$errorClass.'"')?>
                                ...
                                <div class="form-group <?=form_error('drivername') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('drivername') ? 'is-invalid' : '' ?>" id="drivername" name="drivername"  value="<?=set_value('drivername')?>">
                                ...
                                <div class="form-group <?=form_error('driverlicence') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('driverlicence') ? 'is-invalid' : '' ?>" id="driverlicence" name="driverlicence"  value="<?=set_value('driverlicence')?>">
                                ...
                                <div class="form-group <?=form_error('drivercontact') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('drivercontact') ? 'is-invalid' : '' ?>" id="drivercontact" name="drivercontact"  value="<?=set_value('drivercontact')?>">
                                ...
                                <div class="form-group <?=form_error('type') ? 'text-danger' : '' ?>">
                                    <label class="control-label" for="type"><?=$this->lang->line('ambulance_type')?> <span class="text-danger">*</span></label>
                                        ...
                                        echo form_dropdown('type', $typeArray,  set_value('type'), ' class="form-control select2 '.$errorClass.'"')?>
                                ...
                                <div class="form-group <?=form_error('note') ? 'text-danger' : '' ?>">
                                    ...
                                    <textarea type="text" class="form-control <?=form_error('note') ? 'is-invalid' : '' ?>" id="note" name="note" rows="3"><?=set_value('note')?></textarea>
                            ...
                            <div class="card-footer"> 
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('ambulance_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php } ?>
            <div class="<?=(permissionChecker('ambulance_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
