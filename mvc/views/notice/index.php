                        ...
                        <form role="form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group <?=form_error('date') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('date') ? 'is-invalid' : '' ?> datepicker" id="date" name="date"  value="<?=set_value('date')?>">
                                ...
                                <div class="form-group <?=form_error('notice') ? 'text-danger' : '' ?>">
                                    ...
                                    <textarea type="text" class="form-control <?=form_error('notice') ? 'is-invalid' : '' ?>" id="notice" name="notice" rows="10"><?=set_value('notice')?></textarea>
                                    <span><?=form_error('notice')?></span>
                                </div>
                            </div>
                            <div class="card-footer"> 
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('notice_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php } ?>
            <div class="<?=(permissionChecker('notice_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
