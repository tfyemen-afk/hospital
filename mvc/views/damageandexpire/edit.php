        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="<?=site_url('damageandexpire/index/'.$displayID)?>"><?=$this->lang->line('menu_damageandexpire')?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('damageandexpire_edit')?></li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <form role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-block">
                            <div class="form-group <?=form_error('type') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="type"><?=$this->lang->line('damageandexpire_type')?><span class="text-danger"> *</span></label>
                                 <?php
                                    ...
                                    echo form_dropdown('type', $typeArray,  set_value('type', $damageandexpire->type), ' class="form-control select2 '.$errorClass.'" id="type"'); ?>
                            ...
                            <div class="form-group <?=form_error('medicinecategoryID') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="medicinecategoryID"><?=$this->lang->line('damageandexpire_category')?><span class="text-danger"> *</span></label>
                                 <?php
                                    ...
                                    echo form_dropdown('medicinecategoryID', $categoryArray,  set_value('medicinecategoryID', $damageandexpire->medicinecategoryID), ' class="form-control select2 '.$errorClass.'" id="medicinecategoryID"'); ?>
                            ...
                            <div class="form-group <?=form_error('medicineID') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="medicineID"><?=$this->lang->line('damageandexpire_medicine')?><span class="text-danger"> *</span></label>
                                 <?php
                                    ...
                                    echo form_dropdown('medicineID', $medicineArray,  set_value('medicineID', $damageandexpire->medicineID), ' class="form-control select2 '.$errorClass.'" id="medicineID"'); ?>
                                ...
                                <label class="control-label" for="batchID"><?=$this->lang->line('damageandexpire_batchID')?><span class="text-danger"> *</span></label>
                                 <?php
                                    ...
                                    if(inicompute($damageandexpire)) {
                                        $batchArray[$damageandexpire->batchID] = $damageandexpire->batchID;
                                    }
                                    $errorClass = form_error('batchID') ? 'is-invalid' : '';
                                    echo form_dropdown('batchID', $batchArray,  set_value('batchID', $damageandexpire->batchID), ' class="form-control select2 '.$errorClass.'" id="batchID"'); ?>
                            ...
                            <div class="form-group <?=form_error('quantity') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" name="quantity" value="<?=set_value('quantity', $damageandexpire->quantity)?>" class="form-control <?=form_error('quantity') ? 'is-invalid' : ''?>">
                                <span id="quantity-error"><?=form_error('quantity')?></span>
                            </div>
                        </div>
                        <div class="card-footer"> 
                            <button type="submit" class="btn btn-primary"><?=$this->lang->line('damageandexpire_update')?></button>
                        </div>
                    </form>
                </div>
            </div>
