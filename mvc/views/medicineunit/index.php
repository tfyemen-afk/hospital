<article class="content">
        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb pull-right themebreadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_medicineunit')?></li>
              </ol>
            </nav>
        </div>
    </div>
    <section class="section">
        <div class="row">
            <?php if(permissionChecker('medicineunit_add')) { ?>
                <div class="col-sm-4">
                        ...
                        <form role="form" method="POST">
                            ...
                            <div class="card-block">
                                <div class="form-group <?=form_error('medicineunit') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('medicineunit') ? 'is-invalid' : '' ?>" id="medicineunit" name="medicineunit" value="<?=set_value('medicineunit')?>">
                                    <span class="text-danger"><?=form_error('medicineunit')?></span>
                                </div>
                            </div>
                            <div class="card-footer"> 
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('medicineunit_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="<?=(permissionChecker('medicineunit_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
