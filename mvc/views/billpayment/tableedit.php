...
<div class="btn-group pull-right">
    <a href="<?=site_url('billpayment/edit/'.$billpaymentID.'/1/'.$displayuhID)?>" class="btn btn-secondary <?=($displayID == 1) ? 'active' : ''?>"><?=$this->lang->line('billpayment_today')?></a>
    <a href="<?=site_url('billpayment/edit/'.$billpaymentID.'/2/'.$displayuhID)?>" class="btn btn-secondary <?=($displayID == 2) ? 'active' : ''?>"><?=$this->lang->line('billpayment_month')?></a>
    <a href="<?=site_url('billpayment/edit/'.$billpaymentID.'/3/'.$displayuhID)?>" class="btn btn-secondary <?=($displayID == 3) ? 'active' : ''?>"><?=$this->lang->line('billpayment_year')?></a>
    <a href="<?=site_url('billpayment/edit/'.$billpaymentID.'/4/'.$displayuhID)?>" class="btn btn-secondary <?=($displayID == 4) ? 'active' : ''?>"><?=$this->lang->line('billpayment_all')?></a>
</div>
<br>
<br>
<?php } ?>
