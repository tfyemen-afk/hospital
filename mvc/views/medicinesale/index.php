<article class="content">
        ...
        <div class="col-sm-8">
            <nav class="breadcrumb-position" aria-label="breadcrumb">
                <ol class="breadcrumb themebreadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_medicinesale')?></li>
                </ol>
            </nav>
        </div>
    </div>
    <section class="section">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <?php if(permissionChecker('medicinesale_add')) { ?>
                <li class="nav-item">
                    ...
                    <div class="row">
                                    ...
                                    <div class="card-block">
                                        <div class="form-group <?=form_error('patient_type') ? 'text-danger' : '' ?>">
                                            <label class="control-label" for="patient_type"><?=$this->lang->line('medicinesale_patient_type')?><span class="text-danger"> *</span></label>
                                                ...
                                                echo form_dropdown('patient_type', $medicinewarehouseArray,  set_value('patient_type'), ' class="form-control select2 '.$errorClass.'" id="patient_type"')?>
                                        ...
                                        <div class="form-group <?=form_error('medicinesaledate') ? 'text-danger' : '' ?>">
                                            ...
                                            <input type="text" class="form-control datepicker <?=form_error('medicinesaledate') ? 'is-invalid' : '' ?>" id="medicinesaledate" name="medicinesaledate"  value="<?=set_value('medicinesaledate')?>">
                                        ...
                                        <div class="form-group <?=form_error('medicinesaledescription') ? 'text-danger' : '' ?>">
                                            ...
                                            <textarea class="form-control <?=form_error('medicinesaledescription') ? 'is-invalid' : '' ?>" id="medicinesaledescription" name="medicinesaledescription" rows="3" ><?=set_value('medicinesaledescription')?></textarea>
                                            <span><?=form_error('medicinesaledescription')?></span>
                                        </div>
                                    </div>
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary" id="addMedicineButton"><?=$this->lang->line('medicinesale_add')?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="col-sm-9">
                            <div class="card card-custom">
                                <div class="card-header">
                                    <div class="header-block">
                                        <p class="title"><i class="fa fa-braille"></i> &nbsp;<?=$this->lang->line('medicinesale_filter')?></p>
                                    </div>
                                </div>
                                <div class="card-block">
                                    <?php $this->load->view('medicinesale/itemadd');?>
                                </div>
                            </div>
                        </div>
                    </div>
