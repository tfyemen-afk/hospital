        ...
        <div class="col-sm-8">
            <nav class="breadcrumb-position" aria-label="breadcrumb">
                <ol class="breadcrumb themebreadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_leaveassign')?></li>
                </ol>
            </nav>
        </div>
    </div>
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group <?=form_error('leavecategoryID') ? 'text-danger' : '' ?>">
                                    ...
                                    <?php
                                        ...
                                        echo form_dropdown('leavecategoryID', $leavecategoryArray,  set_value('leavecategoryID'), ' class="form-control select2 '.$errorClass.'" ');
                                    ?>
                                ...
                                <div class="form-group <?=form_error('year') ? 'text-danger' : '' ?>">
                                    ...
                                    <?php
                                        ...
                                        echo form_dropdown('year', $yearArray,  set_value('year'), ' class="form-control select2 '.$errorClass.'" ');
                                    ?>
                                ...
                                <div class="form-group <?=form_error('leaveassignday') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('leaveassignday') ? 'is-invalid' : '' ?>" id="leaveassignday" name="leaveassignday"  value="<?=set_value('leaveassignday')?>">
                                    <span><?=form_error('leaveassignday')?></span>
                                </div>
                            </div>
                            <div class="card-footer"> 
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('leaveassign_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php } ?>
            <div class="<?=(permissionChecker('leaveassign_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
