<article class="content">
    ...
    <section class="section">
        <div class="row">
            <?php if(permissionChecker('department_add')) { ?>
                <div class="col-sm-4">
                        ...
                        <form role="form" method="POST">
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group <?=form_error('description') ? 'text-danger' : '' ?>">
                                    ...
                                    <textarea name="description" id="description" class="form-control <?=form_error('description') ? 'is-invalid' : '' ?>" cols="30" rows="10"><?=set_value('description')?></textarea>
                                    <span><?=form_error('description')?></span>
                                </div>
                            </div>
                            <div class="card-footer"> 
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('department_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php } ?>
            <div class="<?=(permissionChecker('department_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
