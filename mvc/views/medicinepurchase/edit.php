<article class="content">
        ...
        <div class="col-sm-8">
            <nav class="breadcrumb-position" aria-label="breadcrumb">
                <ol class="breadcrumb themebreadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?=site_url('medicinepurchase/index/'.$displayID)?>"><?=$this->lang->line('menu_medicinepurchase')?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('medicinepurchase_edit')?></li>
                </ol>
            </nav>
        </div>
    </div>
    <section class="section">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link <?=($activetab) ? '' : 'active'?>" id="add_tab" data-toggle="tab" href="#add" role="tab" aria-controls="add" aria-selected="false"><i class="fa fa-edit"></i> <?=$this->lang->line('panel_edit')?></a>
            </li>
        </ul>
                ...
                <div class="row">
                                ...
                                <div class="card-block">
                                    <div class="form-group <?=form_error('medicinewarehouseID') ? 'text-danger' : '' ?>">
                                        <label class="control-label" for="medicinewarehouseID"><?=$this->lang->line('medicinepurchase_warehouse')?><span class="text-danger"> *</span></label>
                                            ...
                                            echo form_dropdown('medicinewarehouseID', $medicinewarehouseArray,  set_value('medicinewarehouseID', $medicinepurchase->medicinewarehouseID), ' class="form-control select2 '.$errorClass.'" id="medicinewarehouseID"')?>
                                    ...
                                    <div class="form-group <?=form_error('purchase_referenceno') ? 'text-danger' : '' ?>">
                                        ...
                                        <input type="text" class="form-control <?=form_error('purchase_referenceno') ? 'is-invalid' : '' ?>" id="purchase_referenceno" name="purchase_referenceno"  value="<?=set_value('purchase_referenceno', $medicinepurchase->medicinepurchasereferenceno)?>">
                                    ...
                                    <div class="form-group <?=form_error('medicinepurchasedate') ? 'text-danger' : '' ?>">
                                        ...
                                        <input type="text" class="form-control datepicker <?=form_error('medicinepurchasedate') ? 'is-invalid' : '' ?>" id="medicinepurchasedate" name="medicinepurchasedate"  value="<?=set_value('medicinepurchasedate', date('d-m-Y', strtotime($medicinepurchase->medicinepurchasedate)))?>">
                                        <span><?=form_error('medicinepurchasedate')?></span>
                                    </div>
                                    ...
                                    <div class="form-group <?=form_error('payment_status') ? 'text-danger' : '' ?>">
                                        <label class="control-label" for="payment_status"><?=$this->lang->line('medicinepurchase_payment_status')?><span class="text-danger"> *</span></label>
                                            ...
                                            echo form_dropdown('payment_status', $paymentstatusArray,  set_value('payment_status', $medicinepurchase->medicinepurchasestatus), ' class="form-control select2 '.$errorClass.'" id="payment_status"')?>
                                    ...
                                    <div class="form-group <?=form_error('medicinepurchasedescription') ? 'text-danger' : '' ?>">
                                        ...
                                        <textarea class="form-control <?=form_error('medicinepurchasedescription') ? 'is-invalid' : '' ?>" id="medicinepurchasedescription" name="medicinepurchasedescription" rows="3" ><?=set_value('medicinepurchasedescription', $medicinepurchase->medicinepurchasedescription)?></textarea>
                                        <span><?=form_error('medicinepurchasedescription')?></span>
                                    </div>
                                </div>
                                <div class="card-footer"> 
                                    <button type="submit" class="btn btn-primary" id="addMedicineButton"><?=$this->lang->line('medicinepurchase_update')?></button>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="col-sm-9">
                        <div class="card card-custom">
                            ...
                            <div class="card-block">
                                <?php $this->load->view('medicinepurchase/itemedit');?>
                            </div>
                        </div>
                    </div>
                </div>
