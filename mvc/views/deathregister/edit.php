        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?=site_url('deathregister/index/'.$displayID)?>"><?=$this->lang->line('menu_deathregister')?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('deathregister_edit')?></li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <form  autocomplete="off" role="form" method="POST">
                        ...
                        <div class="card-block">
                            <div class="form-group <?=form_error('name') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('name') ? 'is-invalid' : '' ?>" id="name" name="name"  value="<?=set_value('name', $deathregister->name)?>">
                            ...
                            <div class="form-group <?=form_error('relation') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('relation') ? 'is-invalid' : '' ?>" id="relation" name="relation"  value="<?=set_value('relation', $deathregister->relation)?>">
                            ...
                            <div class="form-group <?=form_error('guardian_name') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('guardian_name') ? 'is-invalid' : '' ?>" id="guardian_name" name="guardian_name"  value="<?=set_value('guardian_name', $deathregister->guardian_name)?>">
                            ...
                            <div class="form-group <?=form_error('permanent_address') ? 'text-danger' : '' ?>">
                                ...
                                <textarea type="text" class="form-control <?=form_error('permanent_address') ? 'is-invalid' : '' ?>" id="permanent_address" name="permanent_address" rows="2"><?=set_value('permanent_address', $deathregister->permanent_address)?></textarea>
                            ...
                            <div class="form-group <?=form_error('gender') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="gender"><?=$this->lang->line('deathregister_gender')?> <span class="text-danger">*</span></label>
                                    ...
                                    echo form_dropdown('gender', $genderArray,  set_value('gender', $deathregister->gender), ' class="form-control select2 '.$errorClass.'"')?>
                            ...
                            <div class="form-group <?=form_error('age') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('age') ? 'is-invalid' : '' ?>" id="age" name="age"  value="<?=set_value('age', $deathregister->age)?>">
                            ...
                            <div class="form-group <?=form_error('death_date') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('death_date') ? 'is-invalid' : '' ?>" id="death_date" name="death_date"  value="<?=set_value('death_date', date('d-m-Y h:i A', strtotime($deathregister->death_date)))?>">
                            ...
                            <div class="form-group <?=form_error('nationality') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('nationality') ? 'is-invalid' : '' ?>" id="nationality" name="nationality"  value="<?=set_value('nationality', $deathregister->nationality)?>">
                            ...
                            <div class="form-group <?=form_error('death_cause') ? 'text-danger' : '' ?>">
                                ...
                                <textarea type="text" class="form-control <?=form_error('death_cause') ? 'is-invalid' : '' ?>" id="death_cause" name="death_cause" rows="2"><?=set_value('death_cause', $deathregister->death_cause)?></textarea>
                            ...
                            <div class="form-group <?=form_error('doctorID') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="doctorID"><?=$this->lang->line('deathregister_name_of_the_doctor')?> <span class="text-danger"> *</span></label>
                                    ...
                                    echo form_dropdown('doctorID', $doctorArray,  set_value('doctorID', $deathregister->doctorID), ' class="form-control select2 '.$errorClass.'"')?>
                            ...
                            <div class="form-group <?=form_error('confirm_date') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('confirm_date') ? 'is-invalid' : '' ?>" id="confirm_date" name="confirm_date"  value="<?=set_value('confirm_date', date('d-m-Y h:i A', strtotime($deathregister->confirm_date)))?>">
                            ...
                            <div class="form-group <?=form_error('patientID') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="patientID"><?=$this->lang->line('deathregister_patient')?> </label>
                                    ...
                                    echo form_dropdown('patientID', $patientArray,  set_value('patientID', $deathregister->patientID), ' class="form-control select2 '.$errorClass.'"')?>
                                <span><?=form_error('patientID')?></span>
                            </div>
                        </div>
                        <div class="card-footer"> 
                            <button type="submit" class="btn btn-primary"><?=$this->lang->line('deathregister_update')?></button>
                        </div>
                    </form>
                </div>
            </div>
