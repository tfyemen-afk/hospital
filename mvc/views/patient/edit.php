        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?=site_url('patient/index')?>"><?=$this->lang->line('menu_patient')?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('patient_edit')?></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <?php if(permissionChecker('patient_edit')) { ?>
                        <li class="nav-item">
                            <a class="nav-link <?=($activeedittab) ? 'active' : ''?>" id="edit_tab" data-toggle="tab" href="#edit" role="tab" aria-controls="edit" aria-selected="false"><i class="fa fa-edit"></i> <?=$this->lang->line('panel_edit')?></a>
                        </li>
                    <?php } ?>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <?php if(permissionChecker('patient_edit')) { ?>
                        <div class="tab-pane fade bg-color <?=($activeedittab) ? 'show active' : ''?>" id="edit" role="tabpanel" aria-labelledby="edit_tab">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-6 <?=form_error('name') ? 'text-danger' : ''?>">
                                                ...
                                                <input type="text" class="form-control <?=form_error('name') ? 'is-invalid' : ''?>" name="name" id="name" value="<?=set_value('name', $patient->name)?>"/>
                                            ...
                                            <div class="form-group col-sm-6 <?=form_error('guardianname') ? 'text-danger' : ''?>">
                                                ...
                                                <input type="text" class="form-control <?=form_error('guardianname') ? 'is-invalid' : ''?>" name="guardianname" id="guardianname" value="<?=set_value('guardianname', $patient->guardianname)?>"/>
                                            ...
                                            <div class="form-group col-sm-3 <?=form_error('gender') ? 'text-danger' : ''?>">
                                                ...
                                                <?php
                                                    ...
                                                    echo form_dropdown('gender', $genderArray,  set_value('gender', $patient->gender), 'id="gender" class="form-control select2 '.$errorClass.'"');
                                                ?>
                                            ...
                                            <div class="form-group col-sm-3 <?=form_error('maritalstatus') ? 'text-danger' : ''?>">
                                                ...
                                                <?php
                                                    ...
                                                    echo form_dropdown('maritalstatus', $maritalstatusArray,  set_value('maritalstatus', $patient->maritalstatus), 'id="maritalstatus" class="form-control select2 '.$errorClass.'"');
                                                ?>
                                            ...
                                            <div class="form-group col-sm-6 <?=form_error('phone') ? 'text-danger' : ''?>">
                                                ...
                                                <input type="text" class="form-control <?=form_error('phone') ? 'is-invalid' : ''?>" name="phone" id="phone" value="<?=set_value('phone', $patient->phone)?>"/>
                                            ...
                                            <div class="form-group col-sm-6 <?=form_error('address') ? 'text-danger' : ''?>">
                                                ...
                                                <input type="text" class="form-control <?=form_error('address') ? 'is-invalid' : ''?>" name="address" id="address" value="<?=set_value('address', $patient->address)?>"/>
                                            ...
                                            <div class="form-group col-sm-6 <?=form_error('age_day') ? 'text-danger' : '' ?> <?=form_error('age_month') ? 'text-danger' : '' ?> <?=form_error('age_year') ? 'text-danger' : '' ?>">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input placeholder="mm ex: 11" type="number" max="12" min="0" class="form-control <?=form_error('age_month') ? 'is-invalid' : '' ?>" id="age_month" name="age_month"  value="<?=set_value('age_month', (($patient->age_month == 0) ? '' : $patient->age_month))?>">
                                            ...
                                            <div class="form-group col-sm-4 <?=form_error('height') ? 'text-danger' : ''?>">
                                                ...
                                                <input type="text" class="form-control <?=form_error('height') ? 'is-invalid' : ''?>" name="height" id="height" value="<?=set_value('height', $heightweightbp->height)?>"/>
                                            ...
                                            <div class="form-group col-sm-4 <?=form_error('weight') ? 'text-danger' : ''?>">
                                                ...
                                                <input type="text" class="form-control <?=form_error('weight') ? 'is-invalid' : ''?>" name="weight" id="weight" value="<?=set_value('weight', $heightweightbp->weight)?>"/>
                                            ...
                                            <div class="form-group col-sm-4 <?=form_error('bp') ? 'text-danger' : ''?>">
                                                ...
                                                <input type="text" class="form-control <?=form_error('bp') ? 'is-invalid' : ''?>" name="bp" id="bp" value="<?=set_value('bp', $heightweightbp->bp)?>"/>
                                            ...
                                            <div class="form-group col-sm-6 <?=form_error('symptoms') ? 'text-danger' : ''?>">
                                                ...
                                                <textarea id="symptoms" name="symptoms" class="form-control <?=form_error('symptoms') ? 'is-invalid' : ''?>"><?=set_value('symptoms', (($patient->patienttypeID) ? $admission->symptoms : $appointment->symptoms))?></textarea>
                                            ...
                                            <div class="form-group col-sm-6 <?=form_error('allergies') ? 'text-danger' : ''?>">
                                                ...
                                                <textarea id="allergies" name="allergies" class="form-control <?=form_error('allergies') ? 'is-invalid' : ''?>"><?=set_value('allergies', (($patient->patienttypeID) ? $admission->allergies : $appointment->allergies))?></textarea>
                                            ...
                                            <div class="form-group col-sm-12 <?=form_error('note') ? 'text-danger' : ''?>">
                                                ...
                                                <textarea id="note" name="note" class="form-control <?=form_error('note') ? 'is-invalid' : ''?>"><?=set_value('note', (($patient->patienttypeID) ? $admission->note : $appointment->note))?></textarea>
                                            ...
                                            <div id="emaildiv" class="form-group col-sm-6 <?=form_error('email') ? 'text-danger' : ''?>">
                                                ...
                                                <input type="text" class="form-control <?=form_error('email') ? 'is-invalid' : ''?>" name="email" id="email" value="<?=set_value('email', $user->email)?>"/>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group col-sm-12">
                                            <h6>
                                                <?=($patient->patienttypeID == 0) ? $this->lang->line('patient_appointment_information') : $this->lang->line('patient_admission_information')?>
                                            </h6>
                                        </div>

	                                    <div class="display-none" class="form-group col-sm-12 <?=form_error('patienttypeID') ? 'text-danger' : ''?>">
	                                        ...
	                                        <?php
	                                            ...
	                                            echo form_dropdown('patienttypeID', $patienttypeArray,  set_value('patienttypeID', $patient->patienttypeID), 'id="patienttypeID" class="form-control select2 '.$errorClass.'"');
	                                        ?>
	                                    ...
	                                    <div class="form-group col-sm-12 <?=form_error('oldpatient') ? 'text-danger' : ''?>">
                                            ...
                                            <?php
                                                ...
                                                echo form_dropdown('oldpatient', $visitedArray,  set_value('oldpatient', (($patient->patienttypeID) ? $admission->oldpatient : $appointment->oldpatient)), 'id="oldpatient" class="form-control select2 '.$errorClass.'"');
                                            ?>
	                                    ...
	                                    <div id="appointmentdatediv" class="form-group col-sm-12 <?=form_error('appointmentdate') ? 'text-danger' : ''?>">
	                                        ...
	                                        <input type="text" class="form-control datepicker <?=form_error('appointmentdate') ? 'is-invalid' : ''?>" name="appointmentdate" id="appointmentdate" autocomplete="off" value="<?=set_value('appointmentdate', (($patient->patienttypeID) ? '' : date('d-m-Y h:i A', strtotime($appointment->appointmentdate))))?>"/>
	                                    ...
	                                    <div id="admissiondatediv" class="form-group col-sm-12 <?=form_error('admissiondate') ? 'text-danger' : ''?>">
                                            ...
                                            <input type="text" class="form-control datepicker <?=form_error('admissiondate') ? 'is-invalid' : ''?>" name="admissiondate" id="admissiondate" autocomplete="off" value="<?=set_value('admissiondate', (($patient->patienttypeID) ? date('d-m-Y h:i A', strtotime($admission->admissiondate)) : ''))?>"/>
                                        ...
                                        <div class="form-group col-sm-12 <?=form_error('case') ? 'text-danger' : ''?>">
                                            ...
                                            <input type="text" class="form-control <?=form_error('case') ? 'is-invalid' : ''?>" name="case" id="case" value="<?=set_value('case', (($patient->patienttypeID) ? $admission->pcase : $appointment->pcase))?>"/>
                                        ...
                                        <div class="form-group col-sm-12 <?=form_error('casualty') ? 'text-danger' : ''?>">
                                            ...
                                            <?php
                                                ...
                                                echo form_dropdown('casualty', $casualtyArray,  set_value('casualty', (($patient->patienttypeID) ? $admission->casualty : $appointment->casualty)), 'id="casualty" class="form-control select2 '.$errorClass.'"');
                                            ?>
                                        ...
                                        <div class="form-group col-sm-12 <?=form_error('tpaID') ? 'text-danger' : ''?>">
                                            ...
                                            <?php
                                                ...
                                                echo form_dropdown('tpaID', $tpaArray,  set_value('tpaID', (($patient->patienttypeID) ? $admission->tpaID : $appointment->tpaID)), 'id="tpaID" class="form-control select2 '.$errorClass.'"');
                                            ?>
                                        ...
                                        <div class="form-group col-sm-12 <?=form_error('reference') ? 'text-danger' : ''?>">
                                            ...
                                            <input type="text" class="form-control <?=form_error('reference') ? 'is-invalid' : ''?>" name="reference" id="reference" value="<?=set_value('reference', (($patient->patienttypeID) ? $admission->reference : $appointment->reference))?>"/>
                                            ...
                                            <?php
                                                ...
                                                if(inicompute($doctors)) {
                                                    foreach ($doctors as $doctor) {
                                                        if(($doctor->status == 1 && $doctor->delete_at == 0) || ($doctor->userID == (($patient->patienttypeID) ? $admission->doctorID : $appointment->doctorID))) {
                                                ...
                                                echo form_dropdown('doctorID', $doctorArray,  set_value('doctorID', (($patient->patienttypeID) ? $admission->doctorID : $appointment->doctorID)), 'id="doctorID" class="form-control select2 '.$errorClass.'"');
                                            ?>
                                        ...
                                        <div id="creditlimitdiv" class="form-group col-sm-12 <?=form_error('creditlimit') ? 'text-danger' : ''?>">
                                            ...
                                            <input type="text" class="form-control <?=form_error('creditlimit') ? 'is-invalid' : ''?>" name="creditlimit" id="creditlimit" value="<?=set_value('creditlimit', (($patient->patienttypeID) ? $admission->creditlimit : ''))?>"/>
                                        ...
                                        <div id="amountdiv" class="form-group col-sm-12 <?=form_error('amount') ? 'text-danger' : ''?>">
                                            ...
                                            <input type="text" class="form-control <?=form_error('amount') ? 'is-invalid' : ''?>" name="amount" id="amount" value="<?=set_value('amount', (($patient->patienttypeID) ? '' : $appointment->amount))?>"/>
                                        ...
                                        <div id="paymentstatusdiv" class="form-group col-sm-12 <?=form_error('paymentstatus') ? 'text-danger' : ''?>">
                                            ...
                                            echo form_dropdown('paymentstatus', $paymentStatus,  set_value('paymentstatus', (($patient->patienttypeID) ? '' : $appointment->paymentstatus)), 'id="paymentstatus" class="form-control select2 '.$errorClass.'"');
                                            ?>
                                        ...
                                        <div id="paymentmethoddiv" class="form-group col-sm-12 <?=form_error('paymentmethodID') ? 'text-danger' : ''?>">
                                            ...
                                            <?php
                                                ...
                                                echo form_dropdown('paymentmethodID', $paymentmethodArray,  set_value('paymentmethodID', (($patient->patienttypeID) ? '' : $appointment->paymentmethodID)), 'id="paymentmethodID" class="form-control select2 '.$errorClass.'"');
                                            ?>
                                        ...
                                        <div id="warddiv" class="form-group col-sm-12 <?=form_error('wardID') ? 'text-danger' : ''?>">
                                            ...
                                            <?php
                                                ...
                                                echo form_dropdown('wardID', $wardArray,  set_value('wardID', (($patient->patienttypeID) ? $admission->wardID : '')), 'id="wardID" class="form-control select2 '.$errorClass.'"');
                                            ?>
                                        ...
                                        <div id="beddiv" class="form-group col-sm-12 <?=form_error('bedID') ? 'text-danger' : ''?>">
                                            ...
                                            <?php
                                                ...
                                                if(inicompute($beds)) {
                                                    foreach ($beds as $bed) {
                                                    	if($bed->status == 0 || (($patient->patienttypeID) && ($admission->bedID == $bed->bedID))) {
                                                ...
                                                echo form_dropdown('bedID', $bedArray,  set_value('bedID', (($patient->patienttypeID) ? $admission->bedID : '')), 'id="bedID" class="form-control select2 '.$errorClass.'"');
                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <button class="btn btn-primary"><?=$this->lang->line('patient_update')?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
