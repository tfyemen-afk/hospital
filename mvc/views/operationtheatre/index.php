<article class="content">
        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_operationtheatre')?></li>
                </ol>
            </nav>
        </div>
    </div>
    <section class="section">
        <div class="row">
            <?php if(permissionChecker('operationtheatre_add')) { ?>
                <div class="col-sm-4">
                        ...
                        <form autocomplete="off" role="form" method="POST">
                            ...
                            <div class="card-block">
                                <div class="form-group <?=form_error('operation_name') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('operation_name') ? 'is-invalid' : '' ?>" id="operation_name" name="operation_name"  value="<?=set_value('operation_name')?>">
                                ...
                                <div class="form-group <?=form_error('operation_type') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('operation_type') ? 'is-invalid' : '' ?>" id="operation_type" name="operation_type"  value="<?=set_value('operation_type')?>">
                                ...
                                <div class="form-group <?=form_error('operation_date') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('operation_date') ? 'is-invalid' : '' ?>" id="operation_date" name="operation_date"  value="<?=set_value('operation_date')?>">
                                ...
                                <div class="form-group <?=form_error('assistant_doctor_1') ? 'text-danger' : '' ?>">
                                    <label class="control-label" for="assistant_doctor_1"><?=$this->lang->line('operationtheatre_assistant_doctor_1')?></label>
                                        ...
                                        echo form_dropdown('assistant_doctor_1', $assistant1_Array,  set_value('assistant_doctor_1'), ' id="assistant_doctor_1" class="form-control select2 '.$errorClass.'"')?>
                                ...
                                <div class="form-group <?=form_error('assistant_doctor_2') ? 'text-danger' : '' ?>">
                                    <label class="control-label" for="assistant_doctor_2"><?=$this->lang->line('operationtheatre_assistant_doctor_2')?></label>
                                        <?php
                                        $assistant2_doctorArray['0'] = "— ".$this->lang->line('operationtheatre_please_select')." —";
                                        $errorClass = form_error('assistant_doctor_2') ? 'is-invalid' : '';
                                        echo form_dropdown('assistant_doctor_2', $assistant2_doctorArray,  set_value('assistant_doctor_2'), ' id="assistant_doctor_2" class="form-control select2 '.$errorClass.'"')?>
                                    <span><?=form_error('assistant_doctor_2')?></span>
                                </div>
                            </div>
                            <div class="card-footer"> 
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('operationtheatre_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php } ?>
            <div class="<?=(permissionChecker('operationtheatre_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
