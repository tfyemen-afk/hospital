<article class="content">
        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_discharge')?></li>
                </ol>
            </nav>
        </div>
    </div>
    <section class="section">
        <div class="row">
            <?php if(permissionChecker('discharge_add')) { ?>
                <div class="col-sm-4">
                        ...
                        <form role="form" method="POST">
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group <?=form_error('conditionofdischarge') ? 'text-danger' : ''?>">
                                    ...
                                    echo form_dropdown('conditionofdischarge', $conditionofdischarge,  set_value('conditionofdischarge'), 'id="conditionofdischarge" class="form-control select2 '.$errorClass.'"');
                                    ?>
                                ...
                                <div class="form-group <?=form_error('date') ? 'text-danger' : ''?>">
                                    ...
                                    <input type="text" class="form-control datepicker <?=form_error('date') ? 'is-invalid' : ''?>" name="date" id="date" autocomplete="off" value="<?=set_value('date')?>"/>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('discharge_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php } ?>
            <div class="<?=(permissionChecker('discharge_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
                    ...
                    <div class="card-block">
                        <?php $this->load->view('discharge/table', ['displayViewType' => 'index']); ?>
                    </div>
                </div>
            </div>
        </div>
