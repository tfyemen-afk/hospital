        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?=site_url('blooddonor/index')?>"><?=$this->lang->line('menu_blooddonor')?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('blooddonor_edit')?></li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <form role="form" method="POST">
                        ...
                        <div class="card-block">
                            <div class="form-group <?=form_error('name') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('name') ? 'is-invalid' : '' ?>" id="name" name="name"  value="<?=set_value('name', $blooddonor->name)?>">
                            ...
                            <div class="form-group <?=form_error('gender') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="gender"><?=$this->lang->line('blooddonor_gender')?><span class="text-danger"> *</span></label>
                                    ...
                                    echo form_dropdown('gender', $genderArray,  set_value('gender',$blooddonor->gender),' class="form-control select2 '.$errorClass.'" ')?>
                            ...
                            <div class="form-group <?=form_error('age') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('age') ? 'is-invalid' : '' ?>" id="age" name="age"  value="<?=set_value('age',$blooddonor->age)?>">
                            ...
                            <div class="form-group <?=form_error('bloodgroupID') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="bloodgroupID"><?=$this->lang->line('blooddonor_bloodgroupID')?><span class="text-danger"> *</span></label>
                                    ...
                                    echo form_dropdown('bloodgroupID', $bloodgroupArray,  set_value('bloodgroupID', $blooddonor->bloodgroupID), ' class="form-control select2 '.$errorClass.'"')?>
                            ...
                            <div class="form-group <?=form_error('phone') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('phone') ? 'is-invalid' : '' ?>" id="phone" name="phone"  value="<?=set_value('phone',$blooddonor->phone)?>">
                            ...
                            <div class="form-group <?=form_error('email') ? 'text-danger' : '' ?>">
                                ...
                                <input type="email" class="form-control <?=form_error('email') ? 'is-invalid' : '' ?>" id="email" name="email"  value="<?=set_value('email', $blooddonor->email)?>">
                            ...
                            <div class="form-group <?=form_error('patientID') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="patientID"><?=$this->lang->line('blooddonor_uhid')?></label>
                                    ...
                                    echo form_dropdown('patientID', $patientArray,  set_value('patientID', $blooddonor->patientID), ' class="form-control select2 '.$errorClass.'" ')?>
                            ...
                            <div class="form-group <?=form_error('charges') ? 'text-danger' : '' ?>">
                                ...
                                <input type="charges" class="form-control <?=form_error('charges') ? 'is-invalid' : '' ?>" id="charges" name="charges" value="<?=set_value('charges', $blooddonor->charges)?>">
                            ...
                            <div class="form-group <?=form_error('lastdonationdate') ? 'text-danger' : '' ?>">
                                ...
                                <input type="lastdonationdate" class="form-control datepicker <?=form_error('lastdonationdate') ? 'is-invalid' : '' ?> " id="lastdonationdate" name="lastdonationdate"  value="<?=set_value('lastdonationdate', (!empty($blooddonor->lastdonationdate) ? (date('d-m-Y', strtotime($blooddonor->lastdonationdate))) : ''))?>">
                             ...
                             <div class="form-group <?=form_error('numberofbag') ? 'text-danger' : '' ?>">
                                <label class="control-label" for="numberofbag"><?=$this->lang->line('blooddonor_numberofbag')?><span class="text-danger"> *</span></label>
                                    ...
                                    echo form_dropdown('numberofbag', $numberofbagArray,  set_value('numberofbag', $blooddonor->numberofbag), 'disabled class="form-control numberofbag '.$errorClass.'" ')?>
                        ...
                        <div class="card-footer"> 
                            <button type="submit" class="btn btn-primary"><?=$this->lang->line('blooddonor_update')?></button>
                        </div>
                    </form>
                </div>
            </div>
