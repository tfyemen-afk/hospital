<div class="btn-group pull-right">
    <a href="<?=site_url('prescription/edit/'.$prescriptionID.'/1/'.$displaytypeID.'/'.$displayuhID)?>" class="btn btn-secondary <?=($displayID == 1) ? 'active' : ''?>"><?=$this->lang->line('prescription_today')?></a>
    <a href="<?=site_url('prescription/edit/'.$prescriptionID.'/2/'.$displaytypeID.'/'.$displayuhID)?>" class="btn btn-secondary <?=($displayID == 2) ? 'active' : ''?>"><?=$this->lang->line('prescription_month')?></a>
    <a href="<?=site_url('prescription/edit/'.$prescriptionID.'/3/'.$displaytypeID.'/'.$displayuhID)?>" class="btn btn-secondary <?=($displayID == 3) ? 'active' : ''?>"><?=$this->lang->line('prescription_year')?></a>
    <a href="<?=site_url('prescription/edit/'.$prescriptionID.'/4/'.$displaytypeID.'/'.$displayuhID)?>" class="btn btn-secondary <?=($displayID == 4) ? 'active' : ''?>"><?=$this->lang->line('prescription_all')?></a>
</div>
<br>
<br>
<div id="hide-table">
