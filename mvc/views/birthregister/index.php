<article class="content">
        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb pull-right themebreadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_birthregister')?></li>
              </ol>
            </nav>
        </div>
    </div>
    <section class="section">
        <div class="row">
            <?php if(permissionChecker('birthregister_add')) { ?>
                <div class="col-sm-4">
                        ...
                        <form  autocomplete="off" role="form" method="POST">
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group <?=form_error('father_name') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('father_name') ? 'is-invalid' : '' ?>" id="father_name" name="father_name"  value="<?=set_value('father_name')?>">
                                ...
                                <div class="form-group <?=form_error('mother_name') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('mother_name') ? 'is-invalid' : '' ?>" id="mother_name" name="mother_name"  value="<?=set_value('mother_name')?>">
                                ...
                                <div class="form-group <?=form_error('length') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('length') ? 'is-invalid' : '' ?>" id="length" name="length"  value="<?=set_value('length')?>">
                                ...
                                <div class="form-group <?=form_error('birth_place') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('birth_place') ? 'is-invalid' : '' ?>" id="birth_place" name="birth_place"  value="<?=set_value('birth_place')?>">
                            ...
                            <div class="card-footer"> 
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('birthregister_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php } ?>
            <div class="<?=(permissionChecker('birthregister_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
