        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?=site_url('tpa/index')?>"><?=$this->lang->line('menu_tpa')?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('tpa_edit')?></li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <form role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-block">
                            <div class="form-group <?=form_error('name') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('name') ? 'is-invalid' : '' ?>" id="name" name="name"  value="<?=set_value('name', $tpa->name)?>">
                            ...
                            <div class="form-group <?=form_error('code') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('code') ? 'is-invalid' : '' ?>" id="code" name="code"  value="<?=set_value('code', $tpa->code)?>">
                            ...
                            <div class="form-group <?=form_error('email') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('email') ? 'is-invalid' : '' ?>" id="email" name="email"  value="<?=set_value('email', $tpa->email)?>">
                            ...
                            <div class="form-group <?=form_error('phone') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('phone') ? 'is-invalid' : '' ?>" id="phone" name="phone"  value="<?=set_value('phone', $tpa->phone)?>">
                            ...
                            <div class="form-group <?=form_error('address') ? 'text-danger' : '' ?>">
                                ...
                                <textarea name="address" id="address" class="form-control <?=form_error('address') ? 'is-invalid' : '' ?>" cols="30" rows="3"><?=set_value('address', $tpa->address)?></textarea>
                            ...
                            <div class="form-group <?=form_error('contact_person_name') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('contact_person_name') ? 'is-invalid' : '' ?>" id="contact_person_name" name="contact_person_name"  value="<?=set_value('contact_person_name', $tpa->contact_person_name)?>">
                            ...
                            <div class="form-group <?=form_error('contact_person_phone') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('contact_person_phone') ? 'is-invalid' : '' ?>" id="contact_person_phone" name="contact_person_phone"  value="<?=set_value('contact_person_phone', $tpa->contact_person_phone)?>">
                                <span><?=form_error('contact_person_phone')?></span>
                            </div>
                        </div>
                        <div class="card-footer"> 
                            <button type="submit" class="btn btn-primary"><?=$this->lang->line('tpa_update')?></button>
                        </div>
                    </form>
                </div>
            </div>
