        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page"><a href="<?=site_url('itemstore/index')?>"><?=$this->lang->line('menu_itemstore')?></a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('itemstore_edit')?></li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <form role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-block">
                            <div class="form-group <?=form_error('name') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('name') ? 'is-invalid' : '' ?>" id="name" name="name"  value="<?=set_value('name', $itemstore->name)?>">
                            ...
                            <div class="form-group <?=form_error('code') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('code') ? 'is-invalid' : '' ?>" id="code" name="code"  value="<?=set_value('code', $itemstore->code)?>">
                            ...
                            <div class="form-group <?=form_error('incharge') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('incharge') ? 'is-invalid' : '' ?>" id="incharge" name="incharge"  value="<?=set_value('incharge', $itemstore->incharge)?>">
                            ...
                            <div class="form-group <?=form_error('email') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('email') ? 'is-invalid' : '' ?>" id="email" name="email"  value="<?=set_value('email', $itemstore->email)?>">
                            ...
                            <div class="form-group <?=form_error('phone') ? 'text-danger' : '' ?>">
                                ...
                                <input type="text" class="form-control <?=form_error('phone') ? 'is-invalid' : '' ?>" id="phone" name="phone"  value="<?=set_value('phone', $itemstore->phone)?>">
                            ...
                            <div class="form-group <?=form_error('location') ? 'text-danger' : '' ?>">
                                ...
                                <textarea type="text" class="form-control <?=form_error('location') ? 'is-invalid' : '' ?>" id="location" name="location" rows="3"><?=set_value('location', $itemstore->location)?></textarea>
                                <span><?=form_error('location')?></span>
                            </div>
                        </div>
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary"><?=$this->lang->line('itemstore_update')?></button>
                        </div>
                    </form>
                </div>
            </div>
