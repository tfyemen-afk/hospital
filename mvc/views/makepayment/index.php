        ...
        <div class="col-sm-8">
            <nav class="breadcrumb-position" aria-label="breadcrumb">
                <ol class="breadcrumb themebreadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_makepayment')?></li>
              </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="row">
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-block">
                        <div class="form-group <?=form_error('roleID') ? 'text-danger' : '' ?>">
                            <label class="control-label" for="roleID"><?=$this->lang->line('makepayment_role')?><span class="text-danger"> *</span></label>
                                <?php
                                $roleArray['0'] = $this->lang->line('makepayment_select_role');
                                if(inicompute($roles)) {
            ...
            <div class="col-sm-8">
                <div class="card card-custom">
                    ...
                    <div class="card-block">
                        <?php $this->load->view('makepayment/table'); ?>
                    </div>
                </div>
            </div>
        </div>
