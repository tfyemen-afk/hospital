<article class="content">
        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_itemcheckout')?></li>
                </ol>
            </nav>
        </div>
    </div>
    <section class="section">
        <div class="row">
            <?php if(permissionChecker('itemcheckout_add')) { ?>
                <div class="col-sm-4">
                        ...
                        <form role="form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group <?=form_error('issuedate') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control datetimepicker <?=form_error('issuedate') ? 'is-invalid' : '' ?>" id="issuedate" name="issuedate"  value="<?=set_value('issuedate')?>">
                                ...
                                <div class="form-group <?=form_error('returndate') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control datetimepicker <?=form_error('returndate') ? 'is-invalid' : '' ?>" id="returndate" name="returndate"  value="<?=set_value('returndate')?>">
                                ...
                                <div class="form-group <?=form_error('itemID') ? 'text-danger' : '' ?>">
                                    <label class="control-label" for="itemID"><?=$this->lang->line('itemcheckout_item')?><span class="text-danger"> *</span></label>
                                        ...
                                        echo form_dropdown('itemID', $itemArray,  set_value('itemID'), ' id="itemID" class="form-control select2 '.$errorClass.'"')?>
                            ...
                            <div class="card-footer"> 
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('itemcheckout_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php } ?>
            <div class="<?=(permissionChecker('itemcheckout_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
