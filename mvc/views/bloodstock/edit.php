        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb pull-right themebreadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="<?=site_url('bloodstock/index')?>"><?=$this->lang->line('menu_bloodstock')?></a></li>
                <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('bloodstock_edit')?></li>
              </ol>
            </nav>
        </div>
    </div>
                    ...
                    <form role="form" method="POST">
                        ...
                        <div class="card-block">
                            <div class="form-group <?=form_error('bloodgroupID') ? 'text-danger' : '' ?>">
                                ...
                                echo form_dropdown('bloodgroupID', $bloodgroupArray,  set_value('bloodgroupID', $bloodbag->bloodgroupID), ' class="form-control select2 '.$errorClass.'"')?>
                            ...
                            <div class="form-group <?=form_error('bagno') ? 'text-danger' : '' ?>">
                                ...
                                <input type="bagno" class="form-control <?=form_error('bagno') ? 'is-invalid' : '' ?> " id="bagno" name="bagno"  value="<?=set_value('bagno', $bloodbag->bagno)?>">
                                <span><?=form_error('bagno')?></span>
                            </div>
                        </div>
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary"><?=$this->lang->line('bloodstock_update')?></button>
                        </div>
                    </form>
                </div>
            </div>
