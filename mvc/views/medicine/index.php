<article class="content">
        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb pull-right themebreadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_medicine')?></li>
              </ol>
            </nav>
        </div>
    </div>
    <section class="section">
        <div class="row">
            <?php if(permissionChecker('medicine_add')) { ?>
                <div class="col-sm-4">
                        ...
                        <form role="form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group <?=form_error('medicinecategoryID') ? 'text-danger' : '' ?>">
                                    <label class="control-label" for="medicinecategoryID"><?=$this->lang->line('medicine_category')?><span class="text-danger"> *</span></label>
                                     <?php
                                        ...
                                        echo form_dropdown('medicinecategoryID', $medicinecategoryArray,  set_value('medicinecategoryID'), ' class="form-control select2 '.$errorClass.'"'); ?>
                                ...
                                <div class="form-group <?=form_error('medicinemanufacturerID') ? 'text-danger' : '' ?>">
                                    <label class="control-label" for="medicinemanufacturerID"><?=$this->lang->line('medicine_manufacturer')?><span class="text-danger"> *</span></label>
                                     <?php
                                        ...
                                        echo form_dropdown('medicinemanufacturerID', $medicinemenufactureArray,  set_value('medicinemanufacturerID'), ' class="form-control select2 '.$errorClass.'"'); ?>
                                ...
                                <div class="form-group <?=form_error('medicineunitID') ? 'text-danger' : '' ?>">
                                    <label class="control-label" for="medicineunitID"><?=$this->lang->line('medicine_medicineunit')?><span class="text-danger"> *</span></label>
                                     <?php
                                        ...
                                        echo form_dropdown('medicineunitID', $medicineunitArray,  set_value('medicineunitID'), ' class="form-control select2 '.$errorClass.'"'); ?>
                                ...
                                <div class="form-group <?=form_error('buying_price') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('buying_price') ? 'is-invalid' : '' ?>" id="buying_price" name="buying_price"  value="<?=set_value('buying_price')?>">
                                ...
                                <div class="form-group <?=form_error('selling_price') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('selling_price') ? 'is-invalid' : '' ?>" id="selling_price" name="selling_price"  value="<?=set_value('selling_price')?>">
                                    <span><?=form_error('selling_price')?></span>
                                </div>
                            </div>
                            <div class="card-footer"> 
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('medicine_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php } ?>
            <div class="<?=(permissionChecker('medicine_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
