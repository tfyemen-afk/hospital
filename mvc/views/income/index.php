        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_income')?></li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <form role="form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-block">
                                <div class="form-group <?=form_error('income_name') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('income_name') ? 'is-invalid' : '' ?>" id="income_name" name="income_name"  value="<?=set_value('income_name')?>">
                                ...
                                <div class="form-group <?=form_error('income_date') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('income_date') ? 'is-invalid' : '' ?> datepicker" id="income_date" name="income_date"  value="<?=set_value('income_date')?>">
                                ...
                                <div class="form-group <?=form_error('income_amount') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('income_amount') ? 'is-invalid' : '' ?>" id="income_amount" name="income_amount"  value="<?=set_value('income_amount')?>">
                                ...
                                <div class="form-group <?=form_error('income_note') ? 'text-danger' : '' ?>">
                                    ...
                                    <textarea type="text" class="form-control <?=form_error('income_note') ? 'is-invalid' : '' ?>" id="income_note" name="income_note" rows="5"><?=set_value('income_note')?></textarea>
                                    <span><?=form_error('income_note')?></span>
                                </div>
                            </div>
                            <div class="card-footer"> 
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('income_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php } ?>
            <div class="<?=(permissionChecker('income_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
