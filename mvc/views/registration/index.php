<article class="content">
        ...
        <div class="col-sm-8 pull-right">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb pull-right themebreadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><?=$this->lang->line('menu_registration')?></li>
                </ol>
            </nav>
        </div>
    </div>
    <section class="section">
        <div class="row">
            <?php if(permissionChecker('registration_add')) { ?>
                <div class="col-sm-4">
                        ...
                        <form role="form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-footer">
                                ...
                                <div class="form-group <?=form_error('guardianname') ? 'text-danger' : '' ?>">
                                    ...
                                    <input type="text" class="form-control <?=form_error('guardianname') ? 'is-invalid' : '' ?>" id="guardianname" name="guardianname"  value="<?=set_value('guardianname')?>">
                                ...
                                <div class="form-group <?=form_error('age_day') ? 'text-danger' : '' ?> <?=form_error('age_month') ? 'text-danger' : '' ?> <?=form_error('age_year') ? 'text-danger' : '' ?>">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input placeholder="mm ex: 11" type="number" max="11" min="0" class="form-control <?=form_error('age_month') ? 'is-invalid' : '' ?>" id="age_month" name="age_month"  value="<?=set_value('age_month')?>">
                                ...
                                <div class="form-group <?=form_error('maritalstatus') ? 'text-danger' : '' ?>">
                                    ...
                                    echo form_dropdown('maritalstatus', $maritalstatusArray,  set_value('maritalstatus'), ' class="form-control select2 '.$errorClass.'" ')?>
                                ...
                                <div class="form-group <?=form_error('address') ? 'text-danger' : '' ?>">
                                    ...
                                    <textarea class="form-control <?=form_error('address') ? 'is-invalid' : '' ?>" name="address" rows="3" ><?=set_value('address')?></textarea>
                                ...
                                <div class="form-group <?=form_error('username') ? 'text-danger' : '' ?>">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="input-group-append">
                                            <span class="input-group-text input-group-point" id="newuhid"><?=$this->lang->line('registration_newuhid')?></span>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary"><?=$this->lang->line('registration_add')?></button>
                            </div>
                        </form>
                    </div>
                </div>
            <?php } ?>
            <div class="<?=(permissionChecker('registration_add') ? 'col-sm-8' : 'col-sm-12')?>">
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="header-block">
