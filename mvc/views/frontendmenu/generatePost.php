...
<li class="<?=isset($mergeelement['child']) ? 'mjs-nestedSortable-branch mjs-nestedSortable-expanded' : 'mjs-nestedSortable-leaf'?>" id="<?=$mergeelement['menu_rand']?>">
	<div class="panel panel-default ui-sortable-handle <?=$mergeelement['menu_pageID'].'-'.$rand?>" data-id="<?=$mergeelement['menu_pageID']?>" data-type-id="2" data-rand="<?=$mergeelement['menu_rand']?>">
				...
				<form class="menu-page">
		    		...
		    		<div class="form-group ui-sortable-handle">
		    			<div class="link-to-original ui-sortable-handle">
		    				...
		    				<a target="_blank" href="<?=isset($pluckposts[$mergeelement['menu_pageID']]) ? site_url('frontend/post/'.$pluckposts[$mergeelement['menu_pageID']]->url) : site_url('frontend/post/#')?>"><?=isset($pluckposts[$mergeelement['menu_pageID']]) ? $pluckposts[$mergeelement['menu_pageID']]->title : $mergeelement['menu_label']?></a>
		    			</div>
		    		</div>
		    		<div class="form-group ui-sortable-handle">
