...
class Fmenu_relation_m extends MY_Model
{
    ...
    public function get_fmenu_relation($array=NULL, $signal=FALSE)
    {
        $query = parent::get($array, $signal);
        return $query;
    }

    public function get_order_by_fmenu_relation($array=NULL)
    {
        $query = parent::get_order_by($array);
        return $query;
    }

    public function get_single_fmenu_relation($array=NULL)
    {
        $query = parent::get_single($array);
        return $query;
    }

    public function insert_fmenu_relation($array)
    {
        parent::insert($array);
        return TRUE;
    }
    ...
    public function update_fmenu_relation($data, $id = NULL)
    {
    ...
    public function update_fmenu_relation_by_array($data, $ruleData)
    {
    ...
    public function delete_fmenu_relation_by_array($array)
    {
