...
jQuery(document).ready(function() {
  ...
  jQuery(document).on('click', '#sendpdf', function(){
    ...
    let managesalaryID   = myManageSalaryID;
    let error = 0;
    ...
    if(error === 0) {
      ...
      jQuery.ajax({
        type: 'POST',
        url: THEMEBASEURL+'managesalary/sendmail',
        data: { 'to': to, 'subject': subject, 'message': message, 'managesalaryID': managesalaryID, [CSRFNAME] : CSRFHASH },
        dataType: 'html',
