jQuery(document).on('click', '#sendpdf', function() {
  ...
  if(error === 0) {
    ...
    jQuery.ajax({
      type: 'POST',
      url: THEMEBASEURL+'appointment/sendmail',
      data: { 'to': to, 'subject': subject, 'message': message, 'appointmentID': appointmentID, 'date': date, 'doctorID': doctorID, [CSRFNAME] : CSRFHASH },
      dataType: 'html',
